    ...
    <div class="wp-inner">
                        ...
                        <div class="wrap_time">
                            <div class="time" data-countdown="countdown" data-date="12-12-2022-09-15-45">
                                <div class="lof-labelexpired">
                                    <span class="block-timer">00</span>
                                    <span class="block-timer">00</span>
                                    <span class="block-timer">00</span>
                                </div>
                            </div>
                            ...
                            <ul class="list-item">
                                <li>
                                    <a href="?page=detail_product" title="" class="thumb">
                                        <img src="public/images/iphone 15 pro max (6).webp">
                                    </a>
                                    ...
                                    <div class="action clearfix">
                                        <a href="?page=cart" title="" class="add-cart fl-left mg-l">Thêm giỏ hàng</a>
                                        <a href="?page=checkout" title="" class="buy-now d-none fl-right  ">Mua ngay</a>
                                    </div>
                                </li>
                                <li>
                                    <a href="?page=detail_product" title="" class="thumb">
        ...
        <div class="container">
            <a class="scale_hover" href="#" title="Banner">
                <img class="banner-pc" src="public/images/banner-leng.webp" alt="">    
            </a>
        </div>
        <div class="section" id="list-product-wp">
            <div class="section-head">
        ...
        <!-- BANNER MÁY GIẶT MÁY SẤY -->
        <div class="container">
            <div class="banner-small">
                <a class="scale_hover" href="#" title="Banner_1">
                    <img src="public/images/banner_col_1.webp" alt="">
                </a>
                <a class="scale_hover" href="#" title="Banner_2">
                    <img src="public/images/banner_col_2.webp" alt="">
                </a>
            </div>
        </div>
        <div class="section" id="list-product-wp">
         ...
         <div class="container">
            <div class="banner-small">
                <a class="scale_hover" href="#" title="Banner_1">
                    <img src="public/images/banner_sale_1.webp" alt="">
                </a>
                <a class="scale_hover" href="#" title="Banner_2">
                    <img src="public/images/banner_sale_2.webp" alt="">
                </a>
            </div>
        </div>
    </div>
